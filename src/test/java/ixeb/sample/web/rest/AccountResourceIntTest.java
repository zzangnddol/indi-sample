package ixeb.sample.web.rest;

import ixeb.sample.IxebsampleApp;
import ixeb.sample.config.Constants;
import ixeb.sample.domain.Authority;
import ixeb.sample.domain.PersistentToken;
import ixeb.sample.domain.User;
import ixeb.sample.repository.AuthorityRepository;
import ixeb.sample.repository.PersistentTokenRepository;
import ixeb.sample.repository.UserRepository;
import ixeb.sample.security.AuthoritiesConstants;
import ixeb.sample.service.MailService;
import ixeb.sample.service.UserService;
import ixeb.sample.service.dto.PasswordChangeDTO;
import ixeb.sample.service.dto.UserDTO;
import ixeb.sample.web.rest.errors.ExceptionTranslator;
import ixeb.sample.web.rest.vm.KeyAndPasswordVM;
import ixeb.sample.web.rest.vm.ManagedUserVM;
...
@SpringBootTest(classes = IxebsampleApp.class)
