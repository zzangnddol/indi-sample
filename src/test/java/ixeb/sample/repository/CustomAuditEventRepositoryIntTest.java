package ixeb.sample.repository;

import ixeb.sample.IxebsampleApp;
import ixeb.sample.config.Constants;
import ixeb.sample.config.audit.AuditEventConverter;
import ixeb.sample.domain.PersistentAuditEvent;
...
import static ixeb.sample.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
